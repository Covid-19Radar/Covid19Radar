...
namespace Covid19Radar.Services
{
    ...
    public class UserDataService : IUserDataService
    {
        ...
        public UserDataModel Get()
        {
            ...
            var existsUserData = Application.Current.Properties.ContainsKey(AppConstants.StorageKey.UserData);
        ...
        public async Task SetAsync(UserDataModel userData)
        {
            ...
            Application.Current.Properties[AppConstants.StorageKey.UserData] = Utils.SerializeToJson(userData);
            current = Get();
